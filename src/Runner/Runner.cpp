...
void RunRumScenario(const std::string& appId, const std::string& sessionId)
{
    ...
    // App ID is set once at the start
    SetRumApplicationId(appId.c_str());
    SetRumSession(sessionId.c_str());

    SetRumView("11111111-1111-1111-1111-111111111111", "HomePage");
    std::cout << "View 1: HomePage, session S1 (spinning 2s)..." << std::endl;
    Spin(2000);

    SetRumView(nullptr, nullptr);
    SetRumView("22222222-2222-2222-2222-222222222222", "SettingsPage");
    ...
    SetRumSession(sessionId2.c_str());
    SetRumView("33333333-3333-3333-3333-333333333333", "ProfilePage");
